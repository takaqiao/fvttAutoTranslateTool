...
三轮实测：1333 条 / **73.1 万英文字符**落盘**零拒绝**，标记漂移三次都不升反降。

剩余约 **113 万字符**：常规待译 43.2 万（第 4 批的 33 万已译完待落盘）+
第 8c 项（中文缺块）53.3 万 + 第 8j 项（中文多出内容）4.8 万 + 孪生包独有 14.2 万。
...
| 8m | └ **并行第 4 批**：actors 桶 ×11（内嵌物品与能力） | 🔶 2955 条已译完，待审校后落盘 |
| 8n | └ Ember/Crucible 跨包术语分裂 6 组（Kinesis/Aspect/Glyphweaving/Willpower/Storm 误译） | ⬜ 规则已备 `unify_rules.2026-08-07.json`，待第 4 批落盘后执行 |
