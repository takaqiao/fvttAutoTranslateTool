...
> | 版本 | 日期 | 说明 |
> |---|---|---|
> | **未发布** | — | 1.1.1 之后又落了一批：20 条积压术语分歧、14 个世界地图针脚、两处中文与英文不符（详见第 7 节 E / J 项）。**已提交并推上 main，未打 tag** |
...
| crucible-cn | 汉化模块（本项目） | **0.9.1**（2026-08-12 发布） | `2-Crucible汉化插件\` |
| ember_cn_unofficial | 汉化模块（本项目） | **1.1.1**（2026-08-12 发布） | `1-Ember汉化插件\` |
...
| — | 08-12 | lang 键形态修复、追平批、TM 补齐缺口、死键清理、术语裁决收尾；发 `0.9.1` / `1.1.1` |
