...
**2026-08-16：第二十一轮进行中。当前已发布 `crucible-cn 0.9.9` / `ember_cn_unofficial v1.1.19`。**
...
| ember_cn_unofficial | 汉化模块（本项目） | **v1.1.19**（2026-08-15；v1.1.8/v1.1.9 为阻断急修，v1.1.11–15 为第十四～十五轮，v1.1.16–17 为第十五～十六轮，v1.1.18 为第十七轮，**v1.1.19 为第十八～二十轮**） | `1-Ember汉化插件\` |
