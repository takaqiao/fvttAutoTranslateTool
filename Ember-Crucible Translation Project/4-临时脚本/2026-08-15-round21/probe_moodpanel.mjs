/**
 * Round-21 probe ③c: does the mood panel actually translate the 42 optgroup group
...
const DATA = 'C:/Users/Taka/Desktop/fvtt/Ember-Crucible Translation Project/4-临时脚本/2026-08-15-round21/soundscapes.json';
...
console.log(`  newly covered arrangement labels: ${JSON.stringify(m.aCov)}`);
...
const fail = !ok || !domOk || !whitelistOk || m.bare !== 0 || overlap.length || missingGroupKeys.length || strayGroupKeys.length
