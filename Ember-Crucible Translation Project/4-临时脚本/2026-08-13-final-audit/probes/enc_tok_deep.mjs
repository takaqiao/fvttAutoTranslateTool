import fs from 'fs';
const RAW = 'C:/Users/Taka/AppData/Local/Temp/project-work/C--Users-Taka-Desktop-fvtt/892fdb28-d096-4415-94d1-99d12c38ef86/scratchpad/raw_adv.json';
...
for (const pack of ['adventure','crucible-adventure']) {
  ...
  fs.writeFileSync(`C:/Users/Taka/AppData/Local/Temp/project-work/C--Users-Taka-Desktop-fvtt/892fdb28-d096-4415-94d1-99d12c38ef86/scratchpad/rows_${pack}.json`, JSON.stringify(rows,null,1));
  // adventure actor names
  fs.writeFileSync(`C:/Users/Taka/AppData/Local/Temp/project-work/C--Users-Taka-Desktop-fvtt/892fdb28-d096-4415-94d1-99d12c38ef86/scratchpad/actors_${pack}.json`, JSON.stringify(actors.map(a=>({_id:a._id,name:a.name,proto:a.prototypeToken?.name, link:a.prototypeToken?.actorLink})),null,1));
}
