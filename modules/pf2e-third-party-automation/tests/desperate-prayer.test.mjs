...
test('actorless checks pass through without touching a Prayer window',async()=>{const f=fixture();const fn=f.wrappers.get('game.pf2e.Check.roll');assert.equal(await fn.call({},()=>7,{},{}),7)});
